...
while True:
    ...
    H, vis_ = match_and_draw('find_obj', img1=img1, img2=img2, desc1=desc1, desc2=desc2,  kp1=kp1, kp2=kp2,
                             matcher=matcher) # TODO added after deadline to coupe with lib
    #TODO this lib were taken and changed by me from OpenCV demos, and "No", global variables there are not mine
